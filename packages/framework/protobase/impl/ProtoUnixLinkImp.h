#ifndef _PROTOCOL_UNIX_LINK_IMP_H_
...
class ProtoUnixLinkImp : public NetMod::IEventHandler	
{
public:
    ProtoUnixLinkImp(uint32_t ltype, int encKey, IProtoLinkHandler* handler);
    virtual ~ProtoUnixLinkImp();
...
public:
    ...
    virtual int	OnEvent(NetMod::CNetEvent evt, NetMod::Packet* pkt);	
