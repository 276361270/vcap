// testcap.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "testcap.h"
#include "capture/ivcapmgr.h"
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_TESTCAP, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_TESTCAP));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_TESTCAP);
